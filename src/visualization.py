...
from src.topology import Point4D, rotation_matrix_4d, apply_transformation, Tetrahedron4D # Import from your topology module
...
# Example usage (create a tetrahedron and rotate it)
p1 = Point4D(1, 0, 0, 0)
p2 = Point4D(0, 1, 0, 0)
p3 = Point4D(0, 0, 1, 0)
p4 = Point4D(0, 0, 0, 1)
...
rotation = rotation_matrix_4d(np.pi / 4, plane="xy")
rotated_vertices = [apply_transformation(v, rotation) for v in tetra.vertices]
rotated_tetra = Tetrahedron4D(rotated_vertices)

plot_tetrahedron(rotated_tetra, "Rotated Tetrahedron") 